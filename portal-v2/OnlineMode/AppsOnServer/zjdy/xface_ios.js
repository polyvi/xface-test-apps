...
module.exports = [
    ...
    {
        "file": "plugins/com.polyvi.xface.extension.xapp/www/xapp.js",
    ...
    {
        "file": "plugins/com.polyvi.xface.extension.messaging/www/Messaging.js",
    ...
    {
        "file": "plugins/com.polyvi.xface.extension.device-capability/www/device-capability.js",
 ...
 * 相关参考： {{#crossLink "xFace.Message"}}{{/crossLink}}, {{#crossLink "MessageTypes"}}{{/crossLink}}, {{#crossLink "MessageFolderTypes"}}{{/crossLink}}
 * @class Messaging
 * @static
 * @platform Android, iOS, WP8
 * @since 3.0.0
 ...
 * @param {String} messageType 信息类型（如MMS,SMS,Email），取值范围见{{#crossLink "MessageTypes"}}{{/crossLink}}
 * @param {Function} successCallback 成功回调函数
